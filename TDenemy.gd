...
var coin_scene = preload("res://Entites/coin.tscn")
var heart_scene = preload("res://miniheart.tscn")
var death_sound = preload("res://sounds/enemyhurt.wav.wav")
...
func _physics_process(delta):
	...
	if animation_lock == 0.0:
		...
		var animation = state_animation[int(AI_STATE)]
